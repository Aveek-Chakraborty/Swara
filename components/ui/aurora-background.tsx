...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "relative flex flex-col min-h-screen h-auto items-center justify-center bg-zinc-50 dark:bg-zinc-900  text-slate-950 transition-bg",
          className
        )}
        {...props}
      >
...
//             className={cn(
//               `
//             [--bright-green-gradient:repeating-linear-gradient(100deg,#98FB98_0%,#90EE90_5%,#00FF7F_10%,#32CD32_15%,#7FFF00_20%,#ADFF2F_25%,#00FA9A_30%,#3CB371_35%,#66CDAA_40%,#9ACD32_45%,#8FBC8F_50%)]
//             [--earth-tone-gradient:repeating-linear-gradient(100deg,#556B2F_0%,#8B4513_5%,#D2B48C_10%,#A0522D_15%,#6B8E23_20%,#8B4513_25%,#556B2F_30%,#3CB371_35%,#8FBC8F_40%,#6B8E23_45%,#A0522D_50%)]
//             [--aurora-bright-green:repeating-linear-gradient(100deg,#7FFF00_10%,#98FB98_15%,#ADFF2F_20%,#32CD32_25%,#00FF7F_30%,#66CDAA_35%,#3CB371_40%,#9ACD32_45%,#7FFF00_50%)]
//             [background-image:var(--bright-green-gradient),var(--aurora-bright-green)]
//             dark:[background-image:var(--earth-tone-gradient),var(--aurora-bright-green)]
//             [background-size:300%,_200%]
//             [background-position:50%_50%,50%_50%]
