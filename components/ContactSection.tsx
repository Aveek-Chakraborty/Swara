...
const ContactSection = () => {
  const contactInfo = [
    ...
    {
      title: "Hours",
      details: "Monday - Saturday: 10:00 AM - 4:00 PM",
      icon: (
        <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
  ...
  const socialLinks = [
    {
      ...
      href: "https://www.facebook.com/share/19CMHvmqBu/"
    },
    {
      name: "Instagram",
      icon: (
      ...
      href: "https://www.instagram.com/_s.w.a.r.a____?igsh=MXZwMWhnZWpiODhhdQ=="
    }
  ];
